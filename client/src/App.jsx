      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com" className="hover:text-gray-400" aria-label="Twitter" target="_blank">
            ...
            <a href="https://www.linkedin.com" className="hover:text-gray-400" aria-label="LinkedIn" target="_blank">
